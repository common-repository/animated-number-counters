...
?>
   ...
   function anc_6310_items_per_row($cssData)
   {
   ?>
      <tr height="45">
         <td width="55%">
      ...
      <?php 
         $tablet = isset($cssData['item_per_row_tablet']) ? $cssData['item_per_row_tablet'] : $cssData['item_per_row'];
         $mobile = isset($cssData['item_per_row_mobile']) ? $cssData['item_per_row_mobile'] : 1;
      ?>
      <tr height="45">
         <td width="55%">
            <b>Item Per Row in Tablet <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></b>
         </td>
         <td>
            <select name="item_per_row_tablet" class="anc-6310-form-input anc-6310-no-preview">
               <option value="1" <?php if ($tablet == 1) echo " selected" ?>>1 Item per Row</option>
               <option value="2" <?php if ($tablet == 2) echo " selected" ?>>2 Items per Row</option>
               <option value="3" <?php if ($tablet == 3) echo " selected" ?>>3 Items per Row</option>
               <option value="4" <?php if ($tablet == 4) echo " selected" ?>>4 Items per Row</option>
               <option value="5" <?php if ($tablet == 5) echo " selected" ?>>5 Items per Row</option>
               <option value="6" <?php if ($tablet == 6) echo " selected" ?>>6 Items per Row</option>
            </select>
         </td>
      </tr>
      ...
      <tr height="45">
         <td width="55%">
            <b>Item Per Row in Mobile <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></b>
         </td>
         <td>
            <select name="item_per_row_mobile" class="anc-6310-form-input anc-6310-no-preview">
               <option value="1" <?php if ($mobile == 1) echo " selected" ?>>1 Item per Row</option>
               <option value="2" <?php if ($mobile == 2) echo " selected" ?>>2 Items per Row</option>
               <option value="3" <?php if ($mobile == 3) echo " selected" ?>>3 Items per Row</option>
               <option value="4" <?php if ($mobile == 4) echo " selected" ?>>4 Items per Row</option>
               <option value="5" <?php if ($mobile == 5) echo " selected" ?>>5 Items per Row</option>
               <option value="6" <?php if ($mobile == 6) echo " selected" ?>>6 Items per Row</option>
            </select>
         </td>
      </tr>
   <?php
   ...
   function anc_6310_multi_language_get($field, $value, $id = ''){
      ...
      return anc_6310_special_character_remove(esc_html__($value));
   }
